...
package com.mouritech.driver;

import com.epam.healenium.SelfHealingDriver;
import com.mouritech.constants.FrameworkConstants;
import com.mouritech.enums.Target;
import com.mouritech.exceptions.TargetNotValidException;
    ...
    public WebDriver createInstance() {
        ...
        switch (target) {
            case LOCAL:
            	...
            	WebDriver chromedriver = BrowserFactory.valueOf(FrameworkConstants.BROWSER.toUpperCase()).createDriver();
            	webdriver=SelfHealingDriver.create(chromedriver);
                break;
            case REMOTE:
