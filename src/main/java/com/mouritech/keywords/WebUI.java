...
import com.mouritech.report.ExtentTestManager;
import com.mouritech.utils.BrowserInfoUtils;
import com.mouritech.utils.DateUtils;
...
public class WebUI {
    ...
    public static boolean verifyElementTextContains(By by, String text, FailureHandling flowControl) {
        ...
        //ddScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    ...
    public static void setText(By by, String value) {
        ...
        if (ExtentTestManager.getExtentTest() != null) {
            ExtentReportManager.pass("Set text <b>" + value +"</b>"+" on " + by.toString());
        }
