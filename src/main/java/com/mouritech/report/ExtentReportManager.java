...
import com.mouritech.utils.IconUtils;
import com.mouritech.utils.ReportUtils;
...
//            extentReports.attachReporter(pdf);
    ...
    public static void addScreenShot(Status status, String message) {
        //String base64Image = "data:image/png;base64," + ((TakesScreenshot) DriverManager.getDriver()).getScreenshotAs(OutputType.BASE64);
    	String base64Image = "data:image/png;base64," + ((TakesScreenshot) ((SelfHealingDriver) DriverManager.getDriver()).getDelegate()).getScreenshotAs(OutputType.BASE64);
        //Base64 from Screenshot of Selenium
    ...
    synchronized public static void addAuthors(AuthorType[] authors) {
        if (authors == null) {
            ExtentTestManager.getExtentTest().assignAuthor("Vishal");
        } else {
